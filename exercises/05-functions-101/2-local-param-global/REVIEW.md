...
- [/2-parameter-global.js](#2-parameter-globaljs) - _error_ 
- [/3-parameter-global.js](#3-parameter-globaljs) - _error_ 
- [/5-local-global.js](#5-local-globaljs) - _error_ 
- [/6-local-global.js](#6-local-globaljs) - _error_ 
- [/7-parameter-local-global.js](#7-parameter-local-globaljs) - _error_ 
- [/8-prameter-local-global.js](#8-prameter-local-globaljs) - _error_ 
...
> error 
>
> [review source](./1-parameter-local.js)
...
> error 
>
> [review source](./2-parameter-global.js)
...
> error 
>
> [review source](./3-parameter-global.js)
...
> error 
>
> [review source](./5-local-global.js)
...
> error 
>
> [review source](./6-local-global.js)
...
> error 
>
> [review source](./7-parameter-local-global.js)
...
> error 
>
> [review source](./8-prameter-local-global.js)
...
>  
>
> [review source](./extra-pure-functions.js)
